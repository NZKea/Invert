...
function hamburger(h) {
  if (h.matches) { // If media query matches
    console.log("Appear")
    if (visible === false) {
      var hamelement = document.createElement("a");
      var icon = document.createTextNode("☰");
      hamelement.appendChild(icon);
      hamelement.setAttribute("class", "ham");
      hamelement.setAttribute("onclick", "navbar()");
      hamelement.setAttribute("href", 'javascript:void(0);');
